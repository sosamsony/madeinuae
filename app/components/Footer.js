      ...
      <Flex flexDirection="column" alignItems="center">
        ...
        >
          <Flex flexDirection="column" gap="1.5rem">
            ...
            >
              <Flex gap="2rem" alignItems="center">
                <Link href="https://github.com/sosamsony/madeinuae">
                  <Image src={github.src} alt="github" />
                </Link>
                <Link href="https://linkedin.com/in/sosamsony">
                  <Image src={linkedin.src} alt="linkedin" />
                </Link>
                <Link href="mailto:hello@sosamson.com">
          ...
          >
            ...
            >
              ...
              <Link href="https://github.com/sosamsony/madeinuae/graphs/contributors" isExternal>Contributors</Link>
              <Link href="https://github.com/sosamsony/madeinuae/blob/master/contributing.md" isExternal>Make a Submission</Link>
            </Flex>
        ...
        <Flex mt="5rem" fontSize="sm" flexDirection="column">
          <Text color="#949796" mt={8} fontSize="sm">
            © {new Date().getFullYear()} Made in UAE with ❤️ by{" "}
            <Link
